...
export async function fetchPullRequestContext(config) {
...
export async function updatePullRequestBody(config, pullRequest, body) {
    const octokit = getOctokit(config.githubToken);
...
export async function createIssueComment(config, pullRequest, body) {
    const octokit = getOctokit(config.githubToken);
...
export async function upsertManagedIssueComment(config, pullRequest, marker, body, fallbackHeading) {
    const octokit = getOctokit(config.githubToken);
