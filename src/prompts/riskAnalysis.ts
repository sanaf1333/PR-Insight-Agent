...
export function buildRiskAnalysisPrompt(
  ...
  return [
    ...
    "If the diff is mainly prompt tuning, formatting changes, documentation updates, comment management, or other non-behavioral refactors, prefer exactly: No significant code-level risks identified.",
    ...
    "Do not treat tighter prompt constraints, shorter outputs, or updated wording by themselves as a risk unless they clearly remove required behavior.",
    "",
